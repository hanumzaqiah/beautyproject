...
<head>
  ...
  <title>FACE MIST - BEAUTY PROJECT</title>
  ...
  <section class="product-detail">
    <div class="product-main">
      <div class="product-image">
        <img src="cart2.png" alt="BEAUTY PROJECT WITH FACE MIST">
      </div>
      <div class="product-info">
      <h1>BEAUTY PROJECT FACE MIST</h1>
<p>SKU face mist | Kategori: <strong>Skincare</strong></p>
<p class="price">Rp45.000</p>

<p>
  Face Mist premium dengan kandungan terbaik yang membantu menjaga kelembapan kulit,
  menyegarkan wajah, dan membuat kulit tampak glowing sepanjang hari.
...
<form action="product1.php" method="POST">
  <input type="hidden" name="product_name" value="BEAUTY PROJECT FACE MIST">
...
<div class="product-description">
  ...
  <p><strong>Kenapa Beauty Project Face Mist bikin wajah segar dan glowing?</strong></p>
  <p>Karena semua bahan terbaik untuk hidrasi dan brightening dipakai!</p>

  <h3>Kandungan Utama:</h3>
  <ul>
    <li><strong>Niacinamide</strong></li>
  ...
  <h3>Manfaat Face Mist:</h3>
  <ul>
    <li>Melembapkan wajah seketika</li>
    <li>Menyegarkan kulit lelah</li>
    <li>Mencerahkan kulit kusam</li>
    <li>Menenangkan kulit iritasi ringan</li>
    <li>Membantu makeup lebih tahan lama</li>
    <li>Membuat wajah glowing alami</li>
  </ul>
</div>
