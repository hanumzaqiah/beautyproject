...
<head>
  ...
  <title>ACNE - BEAUTY PRODUCT</title>
  ...
  <section class="product-detail">
    <div class="product-main">
      <div class="product-image">
        <img src="cart5.png" alt="INNERLIGHT GLUTA SLIM DRINK">
      </div>
      <div class="product-info">
       <h1>ACNE PRODUCT BEAUTY PROJECT</h1>
<p>SKU ACNE PRODUCT | Kategori: <strong>Skincare</strong></p>
<p class="price">Rp60.000</p>
<p>Beauty Project Acne Product diformulasikan khusus untuk membantu merawat kulit berjerawat, mengurangi minyak berlebih, dan menjaga kulit tetap sehat.</p>
<p>Availability: <strong>100 in stock</strong></p>

<!-- Form Add to Cart -->
<form action="product4.php" method="POST">
  <input type="hidden" name="product_name" value="ACNE PRODUCT BEAUTY PROJECT">
...
<div class="product-description">
  ...
  <p><strong>Beauty Project Acne Product</strong> mengandung kombinasi bahan aktif seperti:
    <strong>Salicylic Acid</strong>, <strong>Niacinamide</strong>, <strong>Tea Tree Extract</strong>,
    <strong>Centella Asiatica</strong>, <strong>Zinc</strong>, dan <strong>Vitamin C</strong>.
  </p>

  <h3>Manfaat:</h3>
  <ul>
    <li> Membantu mengatasi jerawat aktif</li>
    <li> Mengurangi minyak berlebih</li>
    <li> Menenangkan kulit kemerahan</li>
    <li> Membantu menyamarkan bekas jerawat</li>
    <li> Membersihkan pori-pori</li>
    <li> Mencegah timbulnya jerawat baru</li>
    <li> Menjaga skin barrier</li>
    <li> Membuat kulit lebih sehat dan halus</li>
  </ul>
</div>
