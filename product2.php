...
<head>
  ...
  <title>COLLAGEN - BEAUTY PROJECT</title>
  ...
  <section class="product-detail">
    <div class="product-main">
      <div class="product-image">
        <img src="cart3.png" alt="INNERLIGHT SOAP BAR WITH DNA SALMON">
      </div>
      <div class="product-info">
        <h1>GLUTA COLLAGEN DRINK</h1>
        <p>SKU soap bar Category skincare| Kategori: <strong>Skincare</strong></p>
        <p class="price">Rp60.000</p>
        <p>EMiracle Gluta Collagen Drink, Rahasia minuman kolagen yang diformulasikan khusus oleh nutritionist dan scientist.</p>
        <p>Availability: <strong>100 in stock</strong></p>
    
      <!-- Form Add to Cart -->
        <form action="product2.php" method="POST">
          <input type="hidden" name="product_name" value="GLUTA COLLAGEN DRINKs">
    ...
    <div class="product-description">
      ...
      <p><strong>Kenapa sabun Innerlight cepat banget mencerahkan?</strong></p>
      <p>Karena semua bahan terbaik yang mengandung whitening dipakai!</p>
    
      <h3>Kandungan Utama:</h3>
      <ul>
        <li><strong>DNA Salmon</strong></li>
        <li>Glutathione</li>
        <li>Niacinamide</li>
        <li>Arbutin</li>
        <li>Minyak Bulus</li>
